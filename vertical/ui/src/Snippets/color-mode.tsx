...
export function useColorMode() {
  ...
  return { colorMode: colorMode as ColorMode, setColorMode: setTheme, toggleColorMode }
}
  ...
  function ColorModeButton(props, ref) {
    ...
    return (
      <ClientOnly fallback={<Skeleton boxSize="9" />}>
        <IconButton onClick={toggleColorMode} variant="ghost" aria-label="Toggle color mode" size="sm" ref={ref} {...props} css={{ _icon: { width: '5', height: '5' } }}>
          <ColorModeIcon />
        </IconButton>
      </ClientOnly>
    )
